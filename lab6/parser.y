...
type   : INDIVIDUAL | DECISION | CHAR | FLOAT
...
iostmt  : COME IDENTIFIER | LEAVE IDENTIFIER | COME CONSTANT | LEAVE CONSTANT | COME WORD | LEAVE WORD | COME arrElem
...
whilestmt : PARSING LEFT_ROUND_PARENTHESIS condition RIGHT_ROUND_PARENTHESIS stmt
condition : expression relation expression
relation  : LESS_THAN | LESS_OR_EQUAL_THAN | GREATER_THAN | GREATER_OR_EQUAL_THAN | EQUAL | DIFFERENT | AND | OR
ifstmt : SITUATION LEFT_ROUND_PARENTHESIS condition RIGHT_ROUND_PARENTHESIS stmt OTHER stmt | SITUATION LEFT_ROUND_PARENTHESIS condition RIGHT_ROUND_PARENTHESIS stmt
